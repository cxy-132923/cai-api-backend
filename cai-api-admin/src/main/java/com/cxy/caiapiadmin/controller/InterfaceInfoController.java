package com.cxy.caiapiadmin.controller;

import cn.hutool.json.JSONUtil;
import com.cxy.caiapiadmin.annotation.AuthCheck;
import com.cxy.caiapiadmin.config.GatewayConfig;
import com.cxy.caiapiadmin.exception.BusinessException;
import com.cxy.caiapiadmin.exception.ThrowUtils;
import com.cxy.caiapiadmin.service.InterfaceInfoService;
import com.cxy.caiapiadmin.service.UserService;
import com.cxy.caiapicommon.common.*;
import com.cxy.caiapicommon.constant.CommonConstant;
import com.cxy.caiapicommon.constant.UserConstant;
import com.cxy.caiapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.cxy.caiapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.cxy.caiapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.cxy.caiapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.cxy.caiapicommon.model.entity.InterfaceInfo;
import com.cxy.caiapicommon.model.entity.User;
import com.cxy.caiapicommon.model.enums.InterfaceInfoStatusEnum;
import com.cxy.caiapicommon.model.vo.InterfaceInfoVO;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        CaiApiClient caiApiClient = interfaceInfoService.getCaiApiClient(request);
        // 设置网关地址
        caiApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = caiApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = caiApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
